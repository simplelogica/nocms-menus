module NoCms::Menus::MenuHelper
  ...
  def show_submenu menu_item, options = {}
    ...
    conditional_cache_menu menu_item.menu, options.reverse_merge(initial_cache_key: "submenu-#{menu_item.id}") do
  ...
  def show_children_submenu menu_item, options = {}
    ...
    conditional_cache_menu menu_item.menu, options.reverse_merge(initial_cache_key: "children-submenu-#{menu_item.id}") do
